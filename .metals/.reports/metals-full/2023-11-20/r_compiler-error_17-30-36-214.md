...
### file%3A%2F%2F%2FUsers%2Ftreblocami%2FDesktop%2Fjob%2Fpl_project%2Fproj3%2Fcore%2Fsrc%2Fmain%2Fscala%2Fcs320%2FImplementation.scala:34: error: illegal start of simple expression
    }
    ^
  ...
  object T {
    ...
    def isWellFormed(t: Type, tenv: Map[String, Type]): Boolean = t match{
      ...
      case ArrowT(ptypes, rtype) => 
        ...
        if(allParamsWellFormed&&returnTypeWellFormed)
