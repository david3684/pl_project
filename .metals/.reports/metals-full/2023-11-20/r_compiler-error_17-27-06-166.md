...
### file%3A%2F%2F%2FUsers%2Ftreblocami%2FDesktop%2Fjob%2Fpl_project%2Fproj3%2Fcore%2Fsrc%2Fmain%2Fscala%2Fcs320%2FImplementation.scala:28: error: => expected but } found
    }
    ^
  ...
  object T {
    ...
    def isWellTyped(t: Type, tenv: Map[String, Type]): Boolean = t match{
      ...
      case AppT(name, targs) => 
        val allArgsWellFormed = targs.forall(arg => isWellTyped(arg, tenv))
        // Step 3
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser.caseBody$1(ScalametaParser.scala:2528)
